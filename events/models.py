...
class Event(models.Model):
     ...
     imageEvent=models.ImageField(upload_to='images/',blank=True, null=True )
...
def image_url(self):
        if self.imageEvent:
            print(f'Self imageEvent: {self.imageEvent}')
            return self.imageEvent.url
   # if self.imageEvent and hasattr(self.imageEvent, 'url'):
   #    return self.imageEvent.url